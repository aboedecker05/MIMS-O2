...
Data accessed via a Web of Science search on October 18, 2022. Terms searched include "MIMS and Nitrogen Fixation", "MIMS and Denitrification", and "MIMS and Nitrogen Fixation and Denitrification". Duplicate entries were removed. Search produced 90 papers.
...
ggplot() +
  ...
  scale_x_continuous(name = "", seq(1992,2022,2)) +
  ...
  geom_segment(aes(x = 1992, y = 5.63, xend = 1993.25, yend = 5.63), size = 1) +
  annotate("text", x = 1996, y = 5.63, label= "Citations", size = 5)
```